...
import kr.hs.dgsw.service.BaseDataService;
...
//    }
    ...
    public @ResponseBody List<Map<String, Object>> getqustions(@RequestParam(value="category")String category) throws Exception{
        System.out.println("BaseDataController data : ");

        List<Map<String, Object>> responseData = baseDataService.getquestions(category);

        return responseData;
    }

    @RequestMapping("/postquestion")
    public @ResponseBody Map<String, Object> postquestion(@RequestBody Map<String, Object> params) throws Exception{
        System.out.println("BaseDataController data : "+params);
        baseDataService.postquestion(params);
    ...
    public @ResponseBody Map<String, Object> getqustion(@RequestParam(value="category")String category, @RequestParam(value="id")Integer id) throws Exception{
        System.out.println("BaseDataController data : ");

        Map<String, Object> responseData = baseDataService.getquestion(category, id);

        return responseData;
    }

    @GetMapping("/getcomments")
    public @ResponseBody List<Map<String, Object>> getcomments(@RequestParam(value="category")String category, @RequestParam(value="id")Integer id) throws Exception{
        System.out.println("BaseDataController data : ");

        List<Map<String, Object>> responseData = baseDataService.getcomments(category, id);

        return responseData;
    }

    @RequestMapping("/postcomment")
    public @ResponseBody Map<String, Object> postcomment(@RequestBody Map<String, Object> params) throws Exception{
        System.out.println("BaseDataController data : "+params);
        baseDataService.postcomment(params);
